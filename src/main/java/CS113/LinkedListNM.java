...
public class LinkedListNM<E> implements ListInterface<E>, ListIterableInterface<E>, DequeInterface<E> {
    ...
    private class Iterator<E> implements ListIteratorInterface<E> {
        ...
        private Iterator(LinkedListNM<E> list) {
            this.list = list;
        }
        ...
        public void add(E element) {
            ...
            list.linkNode((LinkedListNM<E>.Node<E>) node, (LinkedListNM<E>.Node<E>) current);
        }
        ...
        public void remove() {
            ...
            list.unlinkNode((LinkedListNM<E>.Node<E>) current);
            current = curr;
        }
